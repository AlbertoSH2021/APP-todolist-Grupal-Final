  ...
  <table>
	...
	<?php 
		...
		{    $numerofila++;    
			...
			echo "<td style='width:26%'> <a href=\"todolist-eliminar2.php?cod_alumno=$mostrar[cod_alumno]\" onClick=\"return confirm('¿ Eliminar tarea $mostrar[usuario]?')\">Eliminar</a></td>";           
		}
	?>
  </table>
